...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('flag', models.CharField(blank=True, choices=[('ack', 'ACK'), ('rst', 'RST'), ('fin', 'FIN'), ('push', 'PUSH'), ('urgent', 'URGENT'), ('syn', 'SYN')], max_length=50, null=True, verbose_name='TCP Flag')),
            ],
            options={
                'db_table': 'tcp_flag',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('accept', 'Accept'), ('discard', 'Discard'), ('community', 'Community'), ('next-term', 'Next term'), ('routing-instance', 'Routing Instance'), ('rate-limit', 'Rate limit'), ('sample', 'Sample')], default='discard', max_length=60, verbose_name='Action')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(help_text='Usar la notación CIDR', max_length=32, verbose_name='Source Address')),
                ('sourceport', models.CharField(blank=True, max_length=65535, null=True, verbose_name='Source Port')),
                ('destination', models.CharField(help_text='Usar la notación CIDR', max_length=32, verbose_name='Destination Address')),
                ...
                ('tcpflag', models.ManyToManyField(blank=True, null=True, to='flowspec.TcpFlag', verbose_name='TCP Flag')),
                ('then', models.ManyToManyField(default='discard', to='flowspec.ThenAction', verbose_name='Then')),
            ],
            options={
